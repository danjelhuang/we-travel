    ...
    when {
        tripCodeResource is Resource.Success<*> -> {
            ...
            Column(modifier = Modifier
                ...
                Button(
                    onClick = {
                        ...
                        if (selectedPredictionId !== "") {
                            ...
                            userViewModel.addDestinations(tripCode, selectedPredictionId, onError = { errorMessage ->
                ...
                Text (
                    errorText,  fontFamily = dmSansFamily
                )
            }
        }
        tripCodeResource is Resource.Loading -> {
            Column(
        ...
        tripCodeResource is Resource.Error -> {
            Column(
                horizontalAlignment = Alignment.CenterHorizontally,
                verticalArrangement = Arrangement.Center,
                modifier = Modifier.fillMaxWidth()
                ...
                Text(text = "Error: $tripCodeErrorMessage", textAlign = TextAlign.Center)
            }
        }
    }
}
